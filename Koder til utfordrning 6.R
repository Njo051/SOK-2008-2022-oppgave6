...
sykefravar_mann <- ggplot(totalmenn, aes(x=år)) +
  geom_line(aes(y=ledigprosent), colour = "yellow") +
  geom_line(aes(y=sykeprosent/manncoeff), colour = "black") +
...
sykefravar_kvinne <- ggplot(totalkvinner, aes(x=år)) +
  geom_line(aes(y=ledigprosent), colour = "yellow") +
  geom_line(aes(y=sykeprosent*kvinnecoeff), colour = "black") +
  scale_y_continuous(name="Ledigprosent",
...
sykefravar_mann + sykefravar_kvinne
